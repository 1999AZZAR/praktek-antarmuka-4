Public Class L02
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        ...
        Call Delay()
    End Sub
    Private Sub B1_SO_Click(sender As System.Object, e As System.EventArgs) Handles B1_SO.Click
        Timer1.Enabled = False
        Timer2.Enabled = False
        Timer3.Enabled = False
        Timer4.Enabled = False
    ...
    End Sub
    Private Sub L02_NIM_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Number(0) = &H3F
        Number(1) = &H6
        Number(2) = &H5B
        Number(3) = &H4F
